        ...
        public override void SetNavigation(INavigationProviderContext context)
        {
            context.Manager.MainMenu
                ...
                // Objects
                    ...
                    .AddItem(new MenuItemDefinition("Object_CargoTypes", new FixedLocalizableString("场地货物类型"), url: "CargoTypes"))
                ...
                // Supervision
                    ...
                    .AddItem(new MenuItemDefinition("Supervisor_InStocks", new FixedLocalizableString("入库单"), url: "Supervisor/InStocks"))
                    .AddItem(new MenuItemDefinition("Supervisor_OutStocks", new FixedLocalizableString("出库单"), url: "Supervisor/OutStocks"))
                    .AddItem(new MenuItemDefinition("Supervisor_Inspects", new FixedLocalizableString("抽检单"), url: "Supervisor/Inspects"))
                    .AddItem(new MenuItemDefinition("Supervisor_Stocktaking", new FixedLocalizableString("盘点"), url: "Supervisor/Stocktaking"))
                );
        }

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CameraIps = table.Column<string>(maxLength: 512, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YellowQuantity = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityInToday = table.Column<double>(nullable: false),
                    QuantityOutToday = table.Column<double>(nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shelves_Objects_ObjectId",
                        column: x => x.ObjectId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Allots_Objects_ObjectId",
                        column: x => x.ObjectId,
                        principalTable: "Objects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inspects_Objects_ObjectId",
                        column: x => x.ObjectId,
                        principalTable: "Objects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InStocks_Objects_ObjectId",
                        column: x => x.ObjectId,
                        principalTable: "Objects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OutStocks_Objects_ObjectId",
                        column: x => x.ObjectId,
                        principalTable: "Objects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Stocktakings_Objects_ObjectId",
                        column: x => x.ObjectId,
                        principalTable: "Objects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Allots_TenantId_ObjectId_CarryoutDate_FromShelfId",
                table: "Allots",
                columns: new[] { "TenantId", "ObjectId", "CarryoutDate", "FromShelfId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Inspects_TenantId_ObjectId_CarryoutDate_ShelfId",
                table: "Inspects",
                columns: new[] { "TenantId", "ObjectId", "CarryoutDate", "ShelfId" });

            migrationBuilder.CreateIndex(
                name: "IX_InStocks_ObjectId",
                table: "InStocks",
                column: "ObjectId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InStocks_TenantId_ObjectId_CarryoutDate_ShelfId",
                table: "InStocks",
                columns: new[] { "TenantId", "ObjectId", "CarryoutDate", "ShelfId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OutStocks_TenantId_ObjectId_CarryoutDate_ShelfId",
                table: "OutStocks",
                columns: new[] { "TenantId", "ObjectId", "CarryoutDate", "ShelfId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Stocktakings_TenantId_ObjectId_CarryoutDate_ShelfId",
                table: "Stocktakings",
                columns: new[] { "TenantId", "ObjectId", "CarryoutDate", "ShelfId" });
